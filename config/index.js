export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wxd2bbd045d568c7e6",

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "a175041bb8a2eb0207099eb403be7288",
  ...
  USERS: [
    {
      ...
      id: "oyv8f5lYw1NRsWkVN1gz8Xp7OuUQ",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "x0SmOcMsUbomqyrZ230UAaLRbdKzzR8RqL2fD8wF8K0",
      // 所在省份
      province: "北京",
      // 所在城市
      city: "北京",
      ...
      festivals: [
        ...
        {"type": "*生日", "name": "武所谓先生", "year": "1999", "date": "04-02"},
